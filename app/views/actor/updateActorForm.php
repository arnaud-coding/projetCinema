...
<div class="d-flex align-items-center">
    ...
    <!-- BOUTON RETOUR -->
    <a class="btn darkBtn btnWithBorders" href="index.php?controller=Actor&action=details&id_actor=<?= $actor->id_actor ?>"
...
<div class="mx-auto lightForm formDarkMode p-3 my-3 w-75">
    <form id="<?= $entity ?>Form" method="post" action="#" enctype="multipart/form-data" novalidate>
        ...
        <div class="mb-3">
            ...
            <input id="firstname" class="form-control" type="text" name="firstname" placeholder="Entrez le prénom" value="<?= htmlspecialchars($actor->firstname, ENT_QUOTES, "UTF-8") ?>">
        ...
        <div class="mb-3">
            ...
            <input id="lastname" type="text" class="form-control" name="lastname" placeholder="Entrez le nom" value="<?= htmlspecialchars($actor->lastname, ENT_QUOTES, "UTF-8") ?>">
        ...
        <div class="mb-3">
            ...
            <input id="birth_date" class="form-control" type="date" name="birth_date" value="<?= htmlspecialchars($actor->birth_date, ENT_QUOTES, "UTF-8") ?>">
        ...
        <div class="mb-3">
            ...
            <input id="death_date" class="form-control" type="date" name="death_date" value="<?= isset($actor->death_date) ? htmlspecialchars($actor->death_date, ENT_QUOTES, "UTF-8") : null ?>">
        ...
        <div class="mb-3">
            ...
            <textarea id="biography" class="form-control" type="text" name="biography" rows="5" placeholder="Renseignez une biographie"><?= isset($actor->biography) ? htmlspecialchars($actor->biography, ENT_QUOTES, "UTF-8") : null ?></textarea>
        ...
        <div class="mb-3">
            ...
            <input id="nationality" class="form-control" type="text" name="nationality" placeholder="Renseignez la nationalité" value="<?= isset($actor->nationality) ? htmlspecialchars($actor->nationality, ENT_QUOTES, "UTF-8") : null ?>">
