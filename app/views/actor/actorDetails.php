...
<?php if (!$actor) { ?>
    <p class="d-flex justify-content-center">Aucune donnée trouvée pour cet acteur</p>
<?php
} else { ?>

    <div class="container mt-4">
        <!-- TITRE PRINCIPAL = TITRE DU FILM -->
        <h2 class="d-flex justify-content-center fw-bolder"><?= htmlspecialchars($actor["details"]->name, ENT_QUOTES, "UTF-8") ?></h2>
